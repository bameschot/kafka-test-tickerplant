...
public class SumTradeWorthConsumer extends AbstractStreamConsumer {
    /*Constants*/

    /*Attributes*/

    /*Constructor*/
    public SumTradeWorthConsumer(String topic) {
        super(topic, "app-sum-trade-worth-consumer", "group-sum-trade-worth-consumer", Serdes.String(), Serdes.Double());
    }
    ...
    public static void main(String[] args) throws Exception {
        new SumTradeWorthConsumer(TickerPlantTopics.T_SUM_TRADE_WORTH).startConsumer();
    }
